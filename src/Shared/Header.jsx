...
function Header() {
  ...
  const navItems = ["Home", "About", "Project", "Others", "Internship"];
    ...
    >
      <nav className="container mx-auto px-6">
        <div className="flex justify-between items-center">
          ...
          >
            <span className="relative z-10 text-black group-hover:text-gray-700 transition-all duration-500">
              BretzPort
            </span>
            <span className="text-black group-hover:scale-110 transition-transform duration-300">
              .
            </span>
